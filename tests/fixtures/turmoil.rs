...
use anyhow::Context;
use client_sdk::{rest_client::NodeApiHttpClient, transaction_builder::ProvableBlobTx};
use hyle::{
...
use super::{
    ctx::E2EContract,
    test_helpers::{wait_height, ConfMaker},
};
use anyhow::Result;
...
impl E2ETurmoilCtx {
    ...
    ) -> (Vec<TurmoilProcess>, Vec<NodeApiHttpClient>) {
    ...
    pub fn client(&self) -> NodeApiHttpClient {
        self.clients[self.client_index].clone()
    }
