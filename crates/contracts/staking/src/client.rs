...
pub struct StakingPseudoExecutor {}
impl ClientSdkExecutor<Staking> for StakingPseudoExecutor {
    fn execute(
        &self,
        contract_input: &sdk::ContractInput<Staking>,
    ) -> anyhow::Result<(Box<Staking>, HyleOutput)> {
...
pub fn deposit_for_fees(
    builder: &mut ProvableBlobTx<Staking>,
