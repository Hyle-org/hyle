...
func TestInitGenesis(t *testing.T) {
	...
	// 	data := &zktx.GenesisState{
	// 		Counters: []zktx.Counter{
	// 			{
	// 				Address: fixture.addrs[0].String(),
	// 				Count:   5,
	// 			},
	// 		},
	// 		Params: zktx.DefaultParams(),
	// 	}
	...
	// 	require.Equal(t, zktx.DefaultParams(), params)
...
func TestExportGenesis(t *testing.T) {
	...
	// _, err := fixture.msgServer.IncrementCounter(fixture.ctx, &zktx.MsgIncrementCounter{
	...
	// require.Equal(t, zktx.DefaultParams(), out.Params)
