...
var (
	...
	fd_MsgPublishPayloadProof_payload       protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgPublishPayloadProof_payload = md_MsgPublishPayloadProof.Fields().ByName("payload")
...
func (x *fastReflection_MsgPublishPayloadProof) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Payload != nil {
		...
		if !f(fd_MsgPublishPayloadProof_payload, value) {
			return
		}
	}
	if len(x.Proof) != 0 {
...
func (x *fastReflection_MsgPublishPayloadProof) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "hyle.zktx.v1.MsgPublishPayloadProof.payload":
...
func (x *MsgPublishPayloadProof) GetPayload() *Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
var file_hyle_zktx_v1_tx_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9d, 0x01, 0x0a, 0x16, 0x4d, 0x73,
	...
	0x65, 0x78, 0x12, 0x2f, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x68, 0x79, 0x6c, 0x65, 0x2e, 0x7a, 0x6b, 0x74, 0x78, 0x2e,
	0x76, 0x31, 0x2e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x04, 0x20, 0x01,
...
var file_hyle_zktx_v1_tx_proto_depIdxs = []int32{
	...
	0, // 1: hyle.zktx.v1.MsgPublishPayloadProof.payload:type_name -> hyle.zktx.v1.Payload
	1, // 2: hyle.zktx.v1.Msg.PublishPayloads:input_type -> hyle.zktx.v1.MsgPublishPayloads
	3, // 3: hyle.zktx.v1.Msg.PublishPayloadProof:input_type -> hyle.zktx.v1.MsgPublishPayloadProof
	5, // 4: hyle.zktx.v1.Msg.RegisterContract:input_type -> hyle.zktx.v1.MsgRegisterContract
	2, // 5: hyle.zktx.v1.Msg.PublishPayloads:output_type -> hyle.zktx.v1.MsgPublishPayloadsResponse
	4, // 6: hyle.zktx.v1.Msg.PublishPayloadProof:output_type -> hyle.zktx.v1.MsgPublishPayloadProofResponse
	6, // 7: hyle.zktx.v1.Msg.RegisterContract:output_type -> hyle.zktx.v1.MsgRegisterContractResponse
